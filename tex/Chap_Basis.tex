...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.5\textwidth]{tongji-whole-logo.pdf}
  \caption{校徽和校名}
  \label{fig:logo}
\end{figure}
...
\begin{figure}[htb!] 
  \centering 
  \begin{tabular}{cc} 
    \includegraphics[width=0.45\textwidth]{tongji-whole-logo.pdf} & \includegraphics[width=0.45\textwidth]{tongji-whole-logo.pdf}\\ 
    (a)图1 & (b)图2
  \end{tabular} 
  \caption{同济大学} 
  \label{fig:subimage} 
...
\begin{figure}[htb!] 
  ...
  \begin{minipage}[t]{.48\linewidth} 
    \centering 
      \includegraphics[width=0.9\textwidth]{tongji-whole-logo.pdf} 
    \caption{图1} 
    \label{fig:quadratic} 
  \end{minipage} 
  \begin{minipage}[t]{.48\linewidth} 
